...
def generate_launch_description():
    ...
    # RViz
    rviz_config_file = (
        get_package_share_directory("robotic_arm_moveit_config") + "/config/moveit_task_execute.rviz"
    )
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
    ...
    moveit_config = MoveItConfigsBuilder("robotic_arm", package_name="robotic_arm_moveit_config").to_dict()
    ...
    delay_pick_n_place = TimerAction(
        period=2.0, 
        actions=[pick_n_place]
    )
